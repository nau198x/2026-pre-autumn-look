...
// ※ Hero のパララックス（sticky な .hero を scrub で上へ逃がす演出）は廃止した。
// iOS 実機で「sticky + transform を書きながらスクロール」が再描画のがくつき・
// Swiper レイヤーのチラ見えを起こすため（2026-07 実機検証）。
// .contents のせり上がり自体は CSS（z-index と通常フロー）だけで成立している
